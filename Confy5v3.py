...
#Gera a Chave para o Server com o Endereço IP
...
# Entrada de chave
tk.Label(root, text="Chave Gerada:").pack()
...
# Entrada de chave para Busca IP
tk.Label(root, text="Chave para Buscar:").pack()
key_entry_search = tk.Entry(root, width=30)
key_entry_search.pack()

buscar_ip_btn = tk.Button(root, text="Buscar IP da Chave", command=ip_output_entry)
buscar_ip_btn.pack(pady=5)
